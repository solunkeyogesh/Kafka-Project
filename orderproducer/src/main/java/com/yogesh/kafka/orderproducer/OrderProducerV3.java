...
@KafkaProducerConfig(bootstrapServers = "localhost:9092", keySerializer = org.apache.kafka.common.serialization.StringSerializer.class, valueSerializer = io.confluent.kafka.serializers.KafkaAvroSerializer.class, acks = "all", retries = 3, lingerMs = 5, batchSize = 32768, compressionType = "gzip", enableIdempotence = true)
